...
Prompt =========================================================
Prompt Iniciando validador - Ejercicio práctico 02 - 04
Prompt Presionar Enter si los valores configurados son correctos.
Prompt De lo contrario editar el script s-06-validador-main-restaura.sql
...
define p_script_validador='s-06p-validador-ejercicios-restaura.plb'
